...
declare global {
    ...
    function $memo<T>(value: T, options?: {
        equals?: false | ((prev: T, next: T) => boolean);
        name?: string;
    }): T;
    function $memo<T>(value: T, options?: {
    ...
    function $effect<T>(fn: (v: T) => T, value: T, options?: {
        name?: string;
    }): void;
    function $computed<T>(fn: (v?: T) => T | undefined): void;
    function $computed<T>(fn: (v: T) => T, value: T, options?: {
        name?: string;
    }): void;
    function $renderEffect<T>(fn: (v?: T) => T | undefined): void;
    function $renderEffect<T>(fn: (v: T) => T, value: T, options?: {
        name?: string;
    }): void;
    function $root<T>(value: T): T;
    function $root<T>(cb: (dispose: () => void) => T): T;
    function $selector<T, U>(source: T, fn?: (a: U, b: T) => boolean, options?: {
        name?: string;
    }): (key: U) => boolean;
    function $on<T, U>(deps: T, fn: (input: T, prevInput: T, prevValue?: U) => U, options?: {
        defer?: boolean;
    }): (prevValue?: U) => U;
    function $deferred<T>(source: T, options?: {
        equals?: false | ((prev: T, next: T) => boolean);
        name?: string;
        timeoutMs?: number;
    }): T;
    ...
    function $lazy<T extends Component<any>>(fn: Promise<{
        default: T;
    }>): T & {
        preload: () => void;
    };
    ...
    function $mapArray<T, U>(arr: readonly T[] | undefined | null | false, mapFn: (v: T, i: Accessor<number>) => U, options?: {
        fallback?: Accessor<any>;
    }): U[];
    function $indexArray<T, U>(arr: readonly T[] | undefined | null | false, mapFn: (v: Accessor<T>, i: number) => U, options?: {
        fallback?: Accessor<any>;
    }): U[];
